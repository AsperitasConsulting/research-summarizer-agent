...
1. **Where do the validated solutions live in the long run?**
   ...
   - **Answer:** A. Spoilers are not a concern.
...
2. **Should `solution/DEFECTS.md` ship in main alongside the solutions, regardless of which option above is chosen?**
   ...
   - **Answer:** Ship alongside the solutions.
...
9. **Solution Phase 9 nondeterminism floor.**
   ...
   - **Answer:** Tighten to NoResultsError.
...
13. **Escalation channel.**
    ...
    - **Answer:** The Esclations markdown should be produced, but the important part is the exit. Work should stop with an escalation.
...
15. **Build-time API key availability.**
    ...
    - **Answer:** Yes, keys will be available for all phases.
...
16. **Solution authoring agent vs. human.**
    ...
    - **Answer:** The solutions consist of written automated test cases.  They will be rewritten by attendees in a separate folder during the workshop.
